...
#     assert run_gendiff(r'C:\Users\M1rr0n\python-project-50\tests\fixtures\file1.json',
#                        r'C:\Users\M1rr0n\python-project-50\tests\fixtures\file2.json') == print(answer)
